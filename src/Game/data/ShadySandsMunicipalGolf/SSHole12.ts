...
const teePosition = findTilePosition(HOLE_12_LAYOUT, 'Y');
const holePosition = findTilePosition(HOLE_12_LAYOUT, 'H');
...
export const hole2Definition: HoleDefinition = {
  ...
  mapData: parseMapLayout(HOLE_12_LAYOUT),
};